...
export default function Contact(){
    return(
        <div  className="min-h-screen flex  bg-gray-500 flex-col items-center justify-center p-8">
            <h1 className="text-3xl font-bold mb-6">Contact me</h1>

            {/* نص تعريفي */}
            <p  className="text-lg text-white mb-8 text-center max-w-xl">If you would like to contact me regarding projects or job
                 opportunities, you can send me a message
                  or contact me through these links.</p>
                  ...
                  {/* فورم للتواصل */}
                  <form className="mt-10 w-full max-w-md bg-gray-700 shadow-md rounded-3xl p-6 space-y-4">
        <input
          type="text"
          placeholder="اسمك"
